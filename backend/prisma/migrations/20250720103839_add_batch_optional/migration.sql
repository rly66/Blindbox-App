/*
  ...
  - You are about to drop the column `boxGroup` on the `Box` table. All the data in the column will be lost.

*/
-- CreateTable
CREATE TABLE "BoxBatch" (
...
INSERT INTO "new_Box" ("claimed", "createdAt", "description", "id", "imageUrl", "isRare", "name", "seriesId") SELECT "claimed", "createdAt", "description", "id", "imageUrl", "isRare", "name", "seriesId" FROM "Box";
DROP TABLE "Box";
