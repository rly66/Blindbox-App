/*
  ...
  - Added the required column `batchNo` to the `BoxBatch` table without a default value. This is not possible if the table is not empty.
...
INSERT INTO "new_BoxBatch" ("createdAt", "id", "seriesId") SELECT "createdAt", "id", "seriesId" FROM "BoxBatch";
DROP TABLE "BoxBatch";
